      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          <div className="flex space-x-4">
            ...
            <button className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Wishlist</button>
            <button className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">Buy Now</button>
          </div>
        </div>
      </div>
    </div>
